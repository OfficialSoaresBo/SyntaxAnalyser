...
public class SyntaxAnalyser extends AbstractSyntaxAnalyser{
    ...
    private void statement() throws IOException, CompilationException {
        ...
        switch(nextToken.symbol){
            ...
            case Token.forSymbol:
                ...
                break;
            default:
                myGenerate.reportError(nextToken,formatError("<statement>",nextToken));
                break;
        }
    ...
    private void assignmentStatement() throws IOException, CompilationException {
        ...
        switch(nextToken.symbol){
            case Token.identifier:
                ...
                break;
            default:
                myGenerate.reportError(nextToken,formatError("<assignment statement>",nextToken));
                break;
        }
    ...
    private void whileStatement() throws IOException, CompilationException {
        ...
        if(nextToken.symbol == Token.whileSymbol){
            ...
            myGenerate.reportError(nextToken,formatError("<while statement>",nextToken));
        }
    ...
    private void procedureStatement() throws IOException, CompilationException {
        ...
        if(nextToken.symbol == Token.callSymbol){
            ...
            myGenerate.reportError(nextToken,formatError("<procedure statement>",nextToken));
        }
    ...
    private void untilStatement() throws CompilationException, IOException {
        ...
        if(nextToken.symbol == Token.doSymbol){
            ...
            myGenerate.reportError(nextToken,formatError("<until statement>",nextToken));
        }
    ...
    private void forStatement() throws CompilationException, IOException {
        ...
        if (nextToken.symbol == Token.forSymbol) {
            ...
            myGenerate.reportError(nextToken,formatError("<for statement>",nextToken));
        }
    ...
    private void condition() throws IOException, CompilationException {
        ...
        if(nextToken.symbol == Token.identifier){
            ...
            myGenerate.reportError(nextToken,formatError("<condition operator>",nextToken));
        }
    ...
    public void conditionalOperator() throws IOException, CompilationException{
        ...
        switch(nextToken.symbol){
            ...
            case Token.lessEqualSymbol:
                ...
                break;
            default:
                myGenerate.reportError(nextToken,formatError("<conditional operator>",nextToken));
                break;
        }
        ...
        while(nextToken.symbol == Token.plusSymbol || nextToken.symbol == Token.timesSymbol || nextToken.symbol == Token.minusSymbol){
            switch(nextToken.symbol){
                ...
                case Token.timesSymbol:
                    ...
                    break;
                default:
                    myGenerate.reportError(nextToken,formatError("<expression operator>",nextToken));
                    break;
            }
        }
        ...
        while(nextToken.symbol == Token.timesSymbol || nextToken.symbol == Token.divideSymbol){
            switch(nextToken.symbol){
                ...
                case Token.divideSymbol:
                    ...
                    break;
                default:
                    myGenerate.reportError(nextToken,formatError("<term operator>",nextToken));
                    break;
            }
        }
    ...
    private void factor() throws IOException, CompilationException{
        ...
        switch(nextToken.symbol){
            ...
            case Token.leftParenthesis:
                ...
                break;
            default:
                myGenerate.reportError(nextToken,formatError("<factor operator>",nextToken));
                break;
        }
